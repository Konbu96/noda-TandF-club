          ...
          <SwiperSlide key={idx}>
            <div className="relative w-full h-[200px] md:h-[300px] group">
              ...
              <button
                ref={prevRef}
                aria-label="前へ"
                className="hidden md:flex items-center justify-center absolute top-1/2 -translate-y-1/2 left-4 z-10 w-10 h-10 rounded-full bg-blue-900/80 text-white hover:bg-blue-900 transition opacity-0 group-hover:opacity-100"
              >
              ...
              <button
                ref={nextRef}
                aria-label="次へ"
                className="hidden md:flex items-center justify-center absolute top-1/2 -translate-y-1/2 right-4 z-10 w-10 h-10 rounded-full bg-blue-900/80 text-white hover:bg-blue-900 transition opacity-0 group-hover:opacity-100"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
